...
__all__ = ['SunpyQtSplashScreen']


class SunpyQtSplashScreen(QtWidgets.QWidget):

    def __init__(self, *args, **kwargs):

        super(SunpyQtSplashScreen, self).__init__(*args, **kwargs)
        ...
        pth = os.path.join(os.path.dirname(__file__), '..', '..', 'glue-solar-logo.png')
