...
class QtDep(Dependency):
    def __init__(self):
        ...
        self.info = 'GUI Library (install at http://bit.ly/YfTFxj or http://bit.ly/Zci3Di)'
        self.package = 'PyQt4'
...
def main(argv=None):
    ...
    %s install astropy
    %s install astronomy
""" % ('glue-deps', 'glue-deps', 'glue-deps', 'glue-deps')

    if len(argv) < 2 or argv[1] not in ['install', 'list']:
